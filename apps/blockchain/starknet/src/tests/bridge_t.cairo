...
mod tests {
    ...
    fn deploy_bridge_and_create_collection(
        ...
        let mut req = setup_request(
            collection_l1, collection_l2, owner_l1, owner_l2, "name", "symbol", "base_uri"
        );
        req.ids = ids;
        let mut buf = array![];
    ...
    fn deposit_token() {
        ...
        bridge.deposit_tokens(0x123, erc721b_address, OWNER_L1, array![0, 1].span(), false, false);
        stop_prank(CheatTarget::One(bridge_address));
    ...
    fn withdraw_token_created_collection_shall_be_whitelisted() {
        ...
        assert_eq!(
            *white_listed.at(0), deployed_address, "Collection whitelisted shall be in list"
        );
    }
    ...
    fn whitelist_collection_is_empty_by_default() {
        ...
        stop_prank(CheatTarget::One(bridge_address));
        assert!(
            bridge.get_white_listed_collections().is_empty(), "White list shall be empty by default"
        );
    }
                    ...
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection3, enabled: false,
                            }
                        )
                    )
                ]
            ...
            .assert_emitted(
                @array![
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection1, enabled: false,
                            }
                        )
                    ),
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection4, enabled: false,
                            }
                        )
                    )
                ]
            ...
            .assert_emitted(
                @array![
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection3, enabled: true,
                            }
                        )
                    ),
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection2, enabled: false,
                            }
                        )
                    )
                ]
            ...
            .assert_emitted(
                @array![
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection1, enabled: true,
                            }
                        )
                    )
                ]
            ...
            .assert_emitted(
                @array![
                    (
                        ...
                        bridge::Event::CollectionWhiteListUpdated(
                            bridge::CollectionWhiteListUpdated {
                                collection: collection2, enabled: true,
                            }
                        )
                    ),
                    (
    ...
    fn upgrade_as_admin() {
        ...
        start_prank(CheatTarget::One(bridge_address), BRIDGE_ADMIN);
        IUpgradeableDispatcher { contract_address: bridge_address }
            .upgrade(erc721b_contract_class.class_hash);
        stop_prank(CheatTarget::One(bridge_address));
        assert!(
            get_class_hash(bridge_address) == erc721b_contract_class.class_hash,
            "Incorrect class hash upgrade"
        );
                    ...
                    (
                        ...
                        bridge::Event::ReplacedClassHash(
                            bridge::ReplacedClassHash {
                                contract: bridge_address, class: erc721b_contract_class.class_hash,
                            }
                        )
                    )
                ]
    ...
    fn support_two_step_transfer_ownership() {
        ...
        let BRIDGE_L1 = EthAddress { address: 'starklane_l1' };
        let ALICE = starknet::contract_address_const::<'alice'>();
        let contract_address = deploy_starklane(
            BRIDGE_ADMIN, BRIDGE_L1, erc721b_contract_class.class_hash
        );
    ...
    fn collection_upgrade_as_admin() {
        ...
        let bridge_deployed_config = deploy_bridge_and_create_collection(
            BRIDGE_L1, COLLECTION_L1, OWNER_L1, OWNER_L2, ids
        );
        ...
        start_prank(CheatTarget::One(bridge_address), BRIDGE_ADMIN);
        IStarklaneCollectionAdminDispatcher { contract_address: bridge_address }
            .collection_upgrade(deployed_address, get_class_hash(bridge_address));
        stop_prank(CheatTarget::One(bridge_address));
        assert!(
            get_class_hash(deployed_address) == get_class_hash(bridge_address),
    ...
    fn collection_transfer_ownership_as_admin() {
        ...
        start_prank(CheatTarget::One(bridge_address), BRIDGE_ADMIN);
        IStarklaneCollectionAdminDispatcher { contract_address: bridge_address }
            .collection_transfer_ownership(erc721b, ALICE);
        stop_prank(CheatTarget::One(bridge_address));
        ...
        spy
            .assert_emitted(
                @array![
                    (
                        bridge_address,
                        bridge::Event::WhiteListEnabled(bridge::WhiteListEnabled { enabled: true, })
                    )
                ]
            );
                ...
                @array![
                    (
                        ...
                        bridge::Event::BridgeL1AddressUpdated(
                            bridge::BridgeL1AddressUpdated { address: NEW_BRIDGE_L1, }
                        )
                    )
                ]
            );
                ...
                @array![
                    (
                        ...
                        bridge::Event::ERC721ClassHashUpdated(
                            bridge::ERC721ClassHashUpdated { class_hash: ERC721_CLASS_HASH, }
                        )
                    )
                ]
            );
                    ...
                    (
                        ...
                        bridge::Event::L1L2CollectionMappingUpdated(
                            bridge::L1L2CollectionMappingUpdated {
                                collection_l1, collection_l2: erc721b_address
                            }
                        )
                    )
                ]
    ...
    fn test_escrow_clearing_after_withdrawal() {
        ...
        let erc721b_address = deploy_erc721b(
            erc721b_contract_class, "TestToken", "TT", bridge_address, COLLECTION_OWNER
        );
        ...
        start_prank(CheatTarget::One(bridge_address), COLLECTION_OWNER);
        bridge.deposit_tokens(0x123, erc721b_address, OWNER_L1, array![0].span(), false, false);
        stop_prank(CheatTarget::One(bridge_address));
        ...
        let collection_l1: EthAddress = 0xe0c.try_into().unwrap();
        let mut req = setup_request(
            collection_l1, erc721b_address, OWNER_L1, OWNER_L2, "TestToken", "TT", "base_uri"
        );
